...
public class CtrlInvoice {
    ...
    @PostMapping
    @Operation(summary = "Creación de factura", description = "Cliente crea una factura con dirección y pago")
    public ResponseEntity<ApiResponse> create(@Valid @RequestBody DtoPurchase purchaseData){
        return ResponseEntity.ok(svc.create(purchaseData));
    }
}